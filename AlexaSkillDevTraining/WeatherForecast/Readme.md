...
COPY . .
RUN dotnet build "WeatherForecast.csproj" --configuration Release --output /app/build

FROM build AS publish
RUN dotnet publish "WeatherForecast.csproj" \
...
Execute unit tests
```
cd "WeatherForecast/test/WeatherForecast.Tests"
dotnet test
```

Deploy function to AWS Lambda
```
cd "WeatherForecast/src/WeatherForecast"
